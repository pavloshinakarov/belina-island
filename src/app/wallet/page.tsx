...
const AppEntyPoint = () => {
  ...
  return (
    <div className="min-h-screen">
      <Navbar />
      <div id="resume" className="color-white">
        <h1>Welcome to Belina Island!</h1>
        ...
        <h1>Why is Belina Island important for our community?</h1>

        Belina Island has been designed with the goal of raising funds for the official Bellscoin donation wallet, but it offers so much more. By participating in this project, the community benefits in three significant ways:

            Utility for Bellscoin: The project adds meaningful utility to Bellscoin, increasing its value and relevance.
            Exposure for Bellinals: It shines a spotlight on Bellinals, giving them well-deserved recognition and visibility.
            Implicit Marketing: By encouraging donations, the community is not just contributing to a cause but also investing in marketing efforts that help grow and expand the Bellscoin ecosystem.

        Belina Island is more than just a project—it&apos;s a testament to the strength and unity of the Bellscoin community. Together, we are building a future where generosity and innovation go hand in hand.
          ...
          <div className="hidden lg:block">
            <div className="bg-base-300">
              <div className="flex justify-between p-4 items-center">
                ...
                {!connected && (
                  <div className="color-white">Please connect your NINTONDO wallet to proceed.</div>
                )}
                {connected && (
            ...
            {connected && (
              <div className="grid grid-cols-2 mt-4 text-sm">
                <div className="text-center bg-base-300 rounded-lg m-5 p-4">
                  <div className="mb-3">SEND $BEL to official Bellscoin donation wallet address</div>
                  <div className="grid gap-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <input
                        ...
                        value="BEGJMVqLYRJkGwvwmsZDDjERpzxGqdyzXT"
                        readOnly
                        onChange={(e) => {
